/**
 * @slydes/slyde-viewer - Type Definitions
 *
 * Core types for Slydes, Frames, FAQs, Reviews, etc.
 * This is the single source of truth for all viewer-related types.
 */
...
/**
 * Location data for map/directions features
 */
