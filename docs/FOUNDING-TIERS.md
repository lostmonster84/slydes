# Slydes Founding Member Tiers

> **Target Raise: £249,775**
> **Total Founders: 225**
...
| Tier | Spots | Price | Revenue Share | Total |
|------|-------|-------|---------------|-------|
| **Genesis** | 50 | £499 | 25% forever | £24,950 |
| **Founding** | 75 | £999 | 20% forever | £74,925 |
| **Charter** | 100 | £1,499 | 15% forever | £149,900 |
| **TOTAL** | **225** | | | **£249,775** |

---

## Tier 1: Genesis Founders (£499)

> *"The originals. The inner circle."*
...
## Tier 2: Founding Members (£999)

> *"Early believers building the future."*

### 75 Spots - Second Wave (Unlocks when Genesis sells out)
...
## Tier 3: Charter Members (£1,499)

> *"Last chance for lifetime access."*

### 100 Spots - Final Wave (Unlocks when Founding sells out)
...
| Feature | Genesis (£499) | Founding (£999) | Charter (£1,499) |
|---------|----------------|-----------------|------------------|
| **Spots** | 50 | 75 | 100 |
...
- Open 50 Genesis spots at £499
- Heavy marketing push
- Goal: Sell out in 2-4 weeks
- Creates urgency + social proof

### Phase 2: Founding Opens
- "Genesis SOLD OUT" messaging
- Open 75 Founding spots at £999
- Genesis founders help spread the word (25% revenue share kicks in)
- Goal: Sell out in 4-6 weeks

### Phase 3: Charter Opens
- "Last chance for lifetime access"
- Open 100 Charter spots at £1,499
- Founders + Founding members spreading
- Goal: Sell out in 6-8 weeks

### Phase 4: Closed
- No more lifetime deals
- Regular subscription pricing only
...
| Tier | Revenue |
|------|---------|
| Genesis (50 × £499) | £24,950 |
| Founding (75 × £999) | £74,925 |
| Charter (100 × £1,499) | £149,900 |
| **TOTAL** | **£249,775** |

### Monthly Recurring (Post-Launch):
- Target: 500 paying users at £39/month = £19,500 MRR
- Year 1 target: £234,000 ARR

### Referral Revenue:
- If each founder refers 2 people at £39/month
- 225 founders × 2 referrals = 450 users
- 450 × £39 = £17,550/month
- Founder payouts (avg 20%): £3,510/month
- Net new MRR: £14,040/month
...
### Charter:
> "Last chance. After these 100 spots, lifetime access is gone forever. Get in before it's subscription-only."
...
A: As long as Slydes exists, you have Pro access. No monthly payments, ever.
...
|------|-----|-----|-----|
| Genesis | £499 | €599 | $629 |
| Founding | £999 | €1,149 | $1,249 |
| Charter | £1,499 | €1,749 | $1,899 |
