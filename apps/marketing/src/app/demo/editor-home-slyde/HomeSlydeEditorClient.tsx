...
import type { FrameData, FAQItem, BusinessInfo, FrameInfoContent, CTAIconType, SocialLinks } from '@/components/slyde-demo/frameData'
...
export function HomeSlydeEditorClient({ initialCategoryId }: HomeSlydeEditorClientProps) {
  ...
  }, [videoSrc, posterSrc, categories, primaryCtaEnabled, primaryCtaText, primaryCtaAction, showCategoryIcons, showHearts, showShare, showSound, showReviews, socialLinks, homeSlyde])
