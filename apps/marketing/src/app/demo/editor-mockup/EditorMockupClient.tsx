...
import type { FrameData, FAQItem, BusinessInfo, CTAIconType, FrameInfoContent } from '@/components/slyde-demo'
...
import { Settings2, HelpCircle, UploadCloud, GripVertical, CalendarDays, Phone, Eye, ArrowRight, Menu, Video, Image as ImageIcon, ChevronDown, Type, Palette, MousePointerClick, Info } from 'lucide-react'
...
export default function EditorMockupClient({ slyde, name }: EditorMockupClientProps) {
  ...
  // CONSTX: Same sidebar state pattern as HomeSlydeEditorClient
  ...
  // Collapsible section state for inspector (CONSTX: matches HomeSlydeEditorClient)
  ...
  // Legacy state - kept for setActiveTab references during slyde switch
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-[#1c1c1e] dark:text-white overflow-hidden">
      <div className="flex h-screen">
        {/* CONSTX: HQSidebar matches HomeSlydeEditorClient */}
        <HQSidebar
          activePage="slydes"
          plan={plan}
          ...
          <header className="h-16 border-b border-gray-200 flex items-center justify-between px-8 shrink-0 bg-white/80 backdrop-blur-xl dark:border-white/10 dark:bg-[#1c1c1e]/80">
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-xs font-semibold text-gray-500 dark:text-white/50 uppercase tracking-wider">Editing</span>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Inspector Panel (CONSTX: Disclosure Groups pattern from HomeSlydeEditorClient) */}
        <aside className="w-80 border-l border-gray-200 dark:border-white/10 bg-white/80 backdrop-blur-xl dark:bg-[#2c2c2e]/80 flex flex-col shrink-0">
          <div className="p-4 border-b border-gray-200/80 dark:border-white/10">
            <h2 className="text-sm font-semibold text-gray-900 dark:text-white">
              {isHomeMode ? 'Home Slyde' : `Frame ${selectedFrame.order}`}
            </h2>
          </div>
                    ...
                    <div className="p-4 space-y-3 border-t border-gray-200 dark:border-white/10">
                      <div className="p-3 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5">
                        <div className="text-[12px] text-gray-600 dark:text-white/60">
                          Video-first entry point. Categories route into Child Slydes.
                        </div>
                      </div>
                      <div>
