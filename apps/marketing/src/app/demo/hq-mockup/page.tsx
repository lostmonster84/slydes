...
export default function HQMockupPage() {
  ...
  // Note: "Create Slyde" actually means "add a category to the Home Slyde" since
  // categories are containers that have Child Slydes (with frames) attached.
  const handleCreateSlyde = () => {
    ...
    if (plan === 'free' && homeSlyde.categories.length >= 1) {
      ...
      router.push('/demo/editor-home-slyde')
    }
  }
                    ...
                    <div className="flex p-6 gap-6">
                      ...
                      <div className="flex-1 flex flex-col py-2">
                        ...
                        <div className="flex items-center gap-2 mt-auto">
                          <Link
                            href={`/demo/editor-home-slyde?category=${category.id}`}
                          ...
                          <Link
                            href={`/demo/home-slyde?category=${category.id}`}
