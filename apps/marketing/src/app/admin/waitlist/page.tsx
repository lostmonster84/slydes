        ...
        <div className="bg-[#2c2c2e] rounded-xl border border-white/10 p-6">
          ...
          <div className="mb-4">
            <input
              ...
              className="w-full px-4 py-2.5 bg-[#3a3a3c] border border-white/10 rounded-lg text-white placeholder:text-[#636366] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
                  ...
                  <tr key={entry.id} className="border-b border-white/5 hover:bg-white/5">
                    <td className="py-3">
                      <div className="flex items-center gap-2">
                        <Mail className="w-4 h-4 text-[#636366]" />
                        <span className="text-white text-sm">{entry.email}</span>
                      </div>
                    </td>
                    <td className="py-3 text-sm text-[#98989d]">
                      {entry.first_name || '—'}
                    </td>
                    <td className="py-3">
                      <span className="text-xs px-2 py-1 rounded-full bg-[#3a3a3c] text-[#98989d]">
                        {getIndustryLabel(entry.industry || 'Not specified')}
                      </span>
                    </td>
                    <td className="py-3 text-sm text-[#636366]">
                      {entry.utm_source || entry.source || 'direct'}
                    </td>
                    <td className="py-3 text-sm text-[#636366] text-right">
