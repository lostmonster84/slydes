      ...
      <div className="bg-white dark:bg-[#2c2c2e] rounded-xl border border-gray-200 dark:border-white/10 p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">All Organizations</h2>
            <InfoIcon
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-gray-100 dark:bg-[#3a3a3c] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400 dark:placeholder-[#636366] text-sm w-72 focus:outline-none focus:border-white/20"
              />
            </div>
            ...
            <select
              ...
              className="px-3 py-2 bg-gray-100 dark:bg-[#3a3a3c] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white text-sm focus:outline-none focus:border-white/20"
            >
            ...
            <button
              ...
              className="px-3 py-2 bg-gray-100 dark:bg-[#3a3a3c] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white text-sm hover:bg-gray-200 dark:hover:bg-[#48484a] transition-colors flex items-center gap-2"
