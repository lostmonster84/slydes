/**
 * Demo Data for WildTrax Marketing Examples
 *
 * This file contains demo/sample data for the WildTrax showcase.
 * Types are imported from @slydes/slyde-viewer shared package.
 *
...
export type { FrameData, FAQItem, BusinessInfo, SlydeConfig, CTAIconType, SocialLinks, ListItem, ListData, FrameInfoContent }
