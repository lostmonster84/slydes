...
export function DevPanel() {
  ...
  return (
    <div className="mx-3 mb-3 space-y-3">
      {/* Plan Testing Panel */}
      <div className="p-3 rounded-lg border-2 border-dashed border-red-500/50 bg-red-50 dark:bg-red-500/10">
      ...
      {/* Demo Generator Panel */}
      <div className="p-3 rounded-lg border-2 border-dashed border-amber-500/50 bg-amber-50 dark:bg-amber-500/10">
        <button
