...
export function MediaSettingsForm({ organizationId, organizationName, existingVideoUid }: Props) {
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 dark:text-white/60 text-sm">
              Uploads go to Cloudflare Stream. After upload, you can set one as your Home video for {organizationName}.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-2xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 dark:text-white/60 text-sm">
              Uploads go to Cloudflare Images (auto-resizing/optimization).
            </p>
          </div>
        </div>
