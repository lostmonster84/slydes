      ...
      <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-white/60 text-sm leading-relaxed">
                Connect a subdomain like <span className="text-gray-900 dark:text-white font-mono">m.yourdomain.com</span> to serve your
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-amber-600 dark:text-amber-500 mb-1">Important: This replaces your mobile site</h3>
        ...
        <div className="bg-gray-100 border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-xl p-4">
          <p className="text-gray-400 dark:text-white/40 text-xs uppercase tracking-wider mb-2">Your current Slydes URL</p>
          <div className="flex items-center gap-2">
            <code className="text-gray-900 dark:text-white font-mono text-sm">{orgSlug}.slydes.io</code>
            <a
        ...
        <div className="bg-white border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-2xl p-6">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-gray-50 border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-leader-blue/50 font-mono"
            />
            <button
              onClick={handleConnect}
              disabled={isLoading || !inputDomain.trim()}
              className="px-6 py-3 bg-leader-blue hover:bg-leader-blue/90 disabled:bg-gray-200 disabled:text-gray-400 dark:disabled:bg-white/10 dark:disabled:text-white/30 text-white rounded-xl font-medium transition-colors"
            >
              {isLoading ? 'Saving...' : 'Connect'}
            </button>
          </div>
          {error && <p className="text-red-500 dark:text-red-400 text-sm mt-2">{error}</p>}
          <p className="text-gray-400 dark:text-white/40 text-xs mt-3">
        ...
        {showWarning && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-white/10 rounded-2xl max-w-md w-full p-6">
              ...
              <p className="text-gray-600 dark:text-white/70 text-sm mb-4 leading-relaxed">
                You&apos;re about to connect <span className="text-gray-900 dark:text-white font-mono">{inputDomain}</span> to your Slydes.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 mb-6">
                <p className="text-amber-600 dark:text-amber-400 text-sm font-medium mb-2">This means:</p>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-gray-100 hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/15 rounded-xl font-medium transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 px-4 py-3 bg-leader-blue hover:bg-leader-blue/90 text-white rounded-xl font-medium transition-colors"
                >
    ...
    <div className="space-y-6">
      ...
      {isVerified ? (
        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-green-600 dark:text-green-500">Domain Connected</h3>
              <p className="text-gray-600 dark:text-white/60 text-sm">
                Your Slydes are live at <span className="font-mono text-gray-900 dark:text-white">{domain}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <AlertTriangle className="w-5 h-5 text-amber-500" />
            <div>
              <h3 className="font-medium text-amber-600 dark:text-amber-500">DNS Configuration Required</h3>
              <p className="text-gray-600 dark:text-white/60 text-sm">
      ...
      <div className="bg-white border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-gray-400 dark:text-white/40 text-xs uppercase tracking-wider mb-1">Connected Domain</p>
            <p className="text-gray-900 dark:text-white font-mono text-lg">{domain}</p>
          </div>
          <div className="flex items-center gap-2">
            {isVerified ? (
              <span className="px-3 py-1 bg-green-500/20 text-green-600 dark:text-green-500 rounded-full text-sm font-medium">
                Verified
              </span>
            ) : (
              <span className="px-3 py-1 bg-amber-500/20 text-amber-600 dark:text-amber-500 rounded-full text-sm font-medium">
                Pending
              </span>
            )}
          </div>
        ...
        <div className="flex gap-4 pt-4 border-t border-gray-200 dark:border-white/10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-gray-500 hover:text-gray-700 dark:text-white/60 dark:hover:text-white transition-colors text-sm"
          >
            <ExternalLink className="w-4 h-4" />
            {orgSlug}.slydes.io
          </a>
      ...
      {!isVerified && (
        <div className="bg-white border border-gray-200 dark:bg-white/5 dark:border-white/10 rounded-2xl p-6">
          ...
          <div className="bg-gray-100 dark:bg-black/30 rounded-xl p-4 space-y-3 font-mono text-sm">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-gray-400 dark:text-white/40">Type:</span>
                <span className="text-gray-900 dark:text-white ml-2">CNAME</span>
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div>
                <span className="text-gray-400 dark:text-white/40">Host/Name:</span>
                <span className="text-gray-900 dark:text-white ml-2">{domain.split('.')[0]}</span>
              </div>
              <button
            ...
            <div className="flex items-center justify-between">
              <div>
                <span className="text-gray-400 dark:text-white/40">Value/Target:</span>
          ...
          <p className="text-gray-400 dark:text-white/40 text-xs mt-4">
          ...
          <button
            ...
            className="mt-4 flex items-center gap-2 px-4 py-2 bg-leader-blue hover:bg-leader-blue/90 disabled:bg-gray-200 dark:disabled:bg-white/10 text-white rounded-xl font-medium transition-colors"
          >
          ...
          <div className="grid gap-3">
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-white/5 rounded-xl">
              <div className="w-10 h-10 bg-gray-200 dark:bg-white/10 rounded-lg flex items-center justify-center flex-shrink-0">
                <Wrench className="w-5 h-5 text-gray-500 dark:text-white/60" />
              </div>
              ...
              <span className="text-green-600 dark:text-green-500 text-sm font-medium">Free</span>
            </div>
...
Thanks!`
              ...
              className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-white/5 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition-colors text-left"
            >
            ...
            <button
              ...
              className="flex items-start gap-4 p-4 bg-gradient-to-r from-leader-blue/10 to-electric-cyan/10 border border-leader-blue/30 rounded-xl hover:from-leader-blue/20 hover:to-electric-cyan/20 transition-colors text-left w-full"
            >
