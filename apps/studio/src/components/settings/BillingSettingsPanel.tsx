...
export function BillingSettingsPanel({ success, canceled }: BillingSettingsPanelProps) {
      ...
      {success && (
        <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <p className="text-green-600 dark:text-green-400">Subscription activated! Welcome to {PLAN_CONFIG[currentPlan].label}.</p>
          </div>
        </div>
      )}
      {canceled && (
        <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
          <p className="text-amber-600 dark:text-amber-400">Checkout cancelled. No charges were made.</p>
        </div>
      )}
      ...
      {isVIP && (
        <div className="p-4 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/30 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-amber-600 dark:text-amber-400">VIP Access Active</p>
              <p className="text-sm text-amber-500/70 dark:text-amber-400/70">You have full Pro features unlocked via promo code</p>
            </div>
          </div>
        </div>
      )}
