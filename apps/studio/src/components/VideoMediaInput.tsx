        ...
        <div className="flex gap-2">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-3 py-2 pr-20 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/15 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 text-sm focus:outline-none focus:border-leader-blue focus:ring-2 focus:ring-leader-blue/40 disabled:opacity-50"
            />
